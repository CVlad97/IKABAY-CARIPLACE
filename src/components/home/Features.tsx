  ...
  const mainFeatures = [
    {
      ...
      description: 'Payez avec Bitcoin, Ethereum ou notre token IKC. Gagnez des récompenses à chaque achat.',
      icon: <Coins className="w-8 h-8" />,
      color: 'from-ocean-500 to-caribbean-500',
      bgColor: 'bg-ocean-50',
      textColor: 'text-ocean-600',
      stats: '+500 transactions/jour'
    },
    {
      title: 'Sécurité Renforcée',
      description: 'Protection avancée avec blockchain, authentification 2FA et chiffrement de bout en bout.',
    ...
    },
    {
      ...
      description: 'Apprenez la culture caribéenne tout en gagnant des tokens et des récompenses.',
      icon: <Gamepad2 className="w-8 h-8" />,
      color: 'from-sunset-500 to-coral-500',
      bgColor: 'bg-sunset-50',
      textColor: 'text-sunset-600',
      stats: '50+ jeux disponibles'
    },
    {
      title: 'Emplois Locaux',
      description: 'Trouvez des opportunités d\'emploi dans toutes les îles des Antilles.',
      icon: <Briefcase className="w-8 h-8" />,
      color: 'from-coral-500 to-sunset-500',
      bgColor: 'bg-coral-50',
      textColor: 'text-coral-600',
      stats: '1000+ offres actives'
    },
  ];

  const additionalFeatures = [
    { icon: <Globe className="w-6 h-6" />, title: 'Multi-îles', desc: 'Couvre toutes les Antilles' },
    { icon: <TrendingUp className="w-6 h-6" />, title: 'Analytics', desc: 'Suivi en temps réel' },
    { icon: <Users className="w-6 h-6" />, title: 'Communauté', desc: '10K+ membres actifs' },
    { icon: <Zap className="w-6 h-6" />, title: 'Performance', desc: 'Chargement ultra-rapide' },
    { icon: <Award className="w-6 h-6" />, title: 'Qualité', desc: 'Produits certifiés' },
    { icon: <Heart className="w-6 h-6" />, title: 'Support', desc: 'Assistance 24/7' },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Découvrez un écosystème complet qui combine commerce, technologie blockchain, 
        ...
        >
          <div className="bg-caribbean-gradient rounded-3xl p-8 md:p-12 text-white">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">
              Prêt à Rejoindre la Révolution ?
            </h3>
            <p className="text-xl mb-8 opacity-90">
              Créez votre compte gratuitement et découvrez toutes ces fonctionnalités
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-caribbean-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
            >
